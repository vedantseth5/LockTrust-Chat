...
export default function ThreadPanel() {
  ...
  function onMentionClick(u: User, anchor: HTMLElement) {
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-sm text-gray-900 leading-relaxed whitespace-pre-wrap break-words">
                  {parseMentions(parentMessage.content, allUsers, currentUser?.id, onMentionClick)}
                </p>
              </div>
            </div>
          </div>
              ...
              <div key={reply.id} className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-sm text-gray-900 whitespace-pre-wrap break-words leading-relaxed">
                    {parseMentions(reply.content, allUsers, currentUser?.id, onMentionClick)}
                  </p>
                </div>
              </div>
            ))}
